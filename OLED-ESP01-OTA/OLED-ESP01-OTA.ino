/*Control de OLED con ESP01
 * Conexion WiFi y programación por OTA
 
 *ESP01- pinout (conexión con display) 
  7-     8-VCC
  5-SDA  6-Rst (VCC)
  3-SCL  4-CE(VCC)
  1-GND  2-
...
rc = oledInit(OLED_128x64, 0, 0, SDAp, SCLp, -1, 400000L); // use standard I2C bus at 400Khz
...
String msg= "Hola probando las string en el ESP-01";
